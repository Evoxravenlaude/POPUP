...
import { useWallet, useMintDrop, usePlaceBid, useIsSubscribedToArtistContract, useSubscribeToArtistContract } from "@/hooks/useContracts";
...
const DropDetailPage = () => {
  ...
  const { mint, isConfirming: isMintConfirming, isSuccess: isMintSuccess, error: mintError } = useMintDrop();
